...
function AboutUs() {
  return (
    <div className="about-container">
      <h1>Our History</h1>
      <p>
        Travelize is owned and managed by Travelize In Pvt. Ltd, a leading brand in
        web designing services and e-commerce solutions. Travelize in Pvt Ltd is
        ...
        rate of other portals managed by Travelize is a live paradigm of our work
        excellence.
      </p>
